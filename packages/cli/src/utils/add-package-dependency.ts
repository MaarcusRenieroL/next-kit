...
import { AvailableDependencies, dependencyVersionMap } from "@/constants/dependency-version.js";

export const addPackageDependency = (opts: { dependencies: AvailableDependencies[]; devMode: boolean; projectDir: string }) => {
