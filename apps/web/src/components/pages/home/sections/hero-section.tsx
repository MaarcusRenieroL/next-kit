...
export const HeroSection: FC = () => {
  return (
    <div className="relative pb-40pt-20 md:pt-20 overflow-hidden px-2 md:px-4 lg:px-8">
      ...
      <div className="max-w-[84rem] w-full mx-auto relative z-20">
        <div
          className="grid grid-cols-1 xl:grid-cols-2 gap-10 pb-10 md:pb-40"
          style={{
            opacity: 1,
            transform: "none",
          }}
        >
          <div className="flex flex-col items-start justify-center xl:px-0 px-8">
            <Badge>npx next-cli</Badge>
            <h1 className="text-4xl md:text-7xl font-bold mb-6 relative text-left dark:text-zinc-100 text-zinc-700 max-w-4xl mt-5">
